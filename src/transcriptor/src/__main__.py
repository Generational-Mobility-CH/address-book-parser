...
from src.file_handler.src.util.get_year_from_file_name import get_year_from_file
from src.shared.common.paths import CITY, DATA_PATH
from src.transcriptor.src.api_openai.write_batch_files import write_batch_files
from src.transcriptor.src.clean_persons import clean_persons_csv
from src.transcriptor.src.constants.csv_header import CSV_HEADER
from src.transcriptor.src.data_convertors.to_batch_api_request import (
    to_batch_api_request,
)
from src.transcriptor.src.model.BacthRequest import BatchRequest
from src.transcriptor.src.model.BatchResponse import BatchResponse
from src.transcriptor.src.setup import setup
