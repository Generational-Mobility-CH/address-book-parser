...
from src.text_parser.src.constants.gender_descriptors import (
    GENDER_FEMALE,
    GENDER_MALE,
    GENDER_UNKNOWN,
)
from src.text_parser.src.constants.female_names_not_ending_in_a import (
    FEMALE_NAMES_NOT_ENDING_IN_A,
)
from src.text_parser.src.constants.male_names_ending_in_a import (
