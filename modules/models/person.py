...
from modules.persons_cleaner.src.transform.standardizer.first_names_standardizer import FirstNamesStandardizer
from modules.persons_cleaner.src.transform.standardizer.job_standardizer import JobStandardizer
from modules.persons_cleaner.src.transform.standardizer.last_names_standardizer import LastNamesStandardizer
from modules.persons_cleaner.src.transform.standardizer.street_name_standardizer import StreetNameStandardizer
...
class Person:
    def __init__(
        self, original_names: str, job: str, address: Address, person_id: uuid.uuid4(), year: int
    ) -> None:
