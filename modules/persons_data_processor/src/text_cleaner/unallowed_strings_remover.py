...
from modules.persons_data_processor.src.text_cleaner.constants.allowed_special_characters import (
    ALLOWED_SPECIAL_CHARACTERS,
)
from modules.persons_data_processor.src.text_cleaner.constants.unallowed_strings import (
    UNALLOWED_STRINGS,
