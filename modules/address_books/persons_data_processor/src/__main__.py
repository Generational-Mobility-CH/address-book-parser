...
from modules.address_books.persons_data_processor.src.address_handler.address_cleaner import (
    clean_address,
)
from modules.address_books.persons_data_processor.src.common.logger import setup_logging
from modules.address_books.persons_data_processor.src.common.paths import (
    PERSONS_OUTPUT_PATH,
    PERSONS_INPUT_PATH,
)
...
from modules.address_books.persons_data_processor.src.parser.parser import (
    parse_address_book,
)
