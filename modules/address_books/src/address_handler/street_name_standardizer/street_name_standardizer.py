...
from modules.address_books.src.address_handler.street_name_standardizer.constants.corrected_street_names import (
    CORRECTED_STREET_NAMES_MAP,
)
from modules.address_books.src.address_handler.street_name_standardizer.constants.historical_street_names_basel import (
    HISTORICAL_STREET_NAMES_BASEL,
)
from modules.address_books.src.address_handler.street_name_standardizer.constants.street_name_prefixes import (
    STREET_NAME_PREFIXES_ABBREVIATION_MAP,
)
from modules.address_books.src.address_handler.street_name_standardizer.constants.street_name_suffixes import (
