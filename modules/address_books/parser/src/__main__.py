...
from modules.address_books.parser.src.common.logger import setup_logging
from modules.address_books.parser.src.common.paths import (
    DATA_PATH,
    PERSONS_OUTPUT_PATH,
    PERSONS_INPUT_PATH,
)
from modules.address_books.parser.src.constants.database_table_names import (
...
from modules.address_books.parser.src.parser.parser import parse_address_book
from modules.address_books.parser.src.street_name_standardizer.street_name_standardizer import (
    standardize_street_name,
)
from modules.address_books.parser.src.util.get_subdirectories import get_subdirectories
